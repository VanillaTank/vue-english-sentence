...
<template>
  ...
  <main class="h-screen w-full p-3 sm:overflow-hidden">
    <div class="max-w-[1200px] mx-auto sm:flex sm:h-full">
      <div class="sm:w-[285px] w-full max-h-full overflow-auto sm:rounded scroll-style scroll-pink sm:p-0 sm:pr-1 fixed top-0 left-0 p-2.5 sm:static flex sm:block justify-between bgi bg-no-repeat bg-[center_-80px] bg-auto sm:!bg-none sm:!bg-transparent">
        <v-how-to-use />
        <v-card-filter />
      </div>
