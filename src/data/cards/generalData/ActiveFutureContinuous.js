export default {
  ...
  theory: `Будущее продолженное время используется для описания действий, которые будут происходить в течение определенного времени в будущем. Это время подчеркивает, что действие будет находиться в процессе выполнения в заданный момент будущего времени.

Когда используется будущее продолженное время:
Действие, которое будет происходить в конкретный момент в будущем:

Пример: "Я буду звонить другу в 8 часов вечера."
Здесь будущее продолженное время указывает на то, что действие звонка будет продолжаться в определенный момент в будущем.
Длительное действие, которое будет происходить в будущем:

Пример: "Они будут работать над проектом всю следующую неделю."
Это время показывает, что действие работы над проектом будет длиться в течение всей следующей недели.
Прогнозы или предположения о будущем:

Пример: "Мы будем ожидать хорошую погоду на выходные."
Используется для выражения предположений о том, что будет происходить в будущем, и показывает, что действие ожидания будет длиться в течение определенного времени.
Запланированные события в будущем:

Пример: "Она будет готовить ужин к приходу гостей."
Это время также может использоваться для описания заранее запланированных событий, которые будут происходить в будущем.
Указатели времени:
Основные слова и выражения, которые обычно используются с будущим продолженным временем, включают "tomorrow" (завтра), "next week" (на следующей неделе), "at 8 o'clock" (в 8 часов) и другие подобные временные маркеры, которые указывают на конкретные моменты или периоды в будущем.

Будущее продолженное время помогает выразить идею о том, что действие будет находиться в процессе выполнения в будущем, добавляя акцент на продолжительность или длительность действия. Это делает его полезным для планирования, прогнозов и описания будущих ситуаций.`,
  schemas: [
